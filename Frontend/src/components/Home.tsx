      ...
      <div className="min-h-screen bg-linear-to-b from-slate-900 via-purple-900 to-slate-900 text-gray-100 font-sans">
        ...
        >
          ...
          <div className="hero-content text-neutral-content text-center flex flex-col">
            ...
            <div>
              {/* UPDATED BUTTON HERE */}
              <button className="btn btn-primary btn-lg border-none bg-linear-to-r from-purple-600 to-pink-600 text-white shadow-lg shadow-purple-500/50 hover:scale-105 transition-transform">
                Shop Now
              </button>
            </div>
          </div>
