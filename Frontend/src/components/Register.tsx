          ...
          <div className="card-body px-8 py-10">
            ...
            <div className="text-center mb-6">
              <h1 className="text-3xl font-black text-white tracking-tight">
                Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Galaxy</span>
              </h1>
              <p className="text-sm text-gray-400 mt-2">Create your intergalactic profile.</p>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-gray-300 text-xs font-bold uppercase tracking-wider">Display Name</span>
                </label>
                <label className="input input-bordered bg-slate-800/50 border-white/10 focus-within:border-purple-500 focus-within:ring-1 focus-within:ring-purple-500 flex items-center gap-2 text-white">
                  ...
                  <input type="text" className="grow placeholder:text-gray-500 bg-transparent" placeholder="SpaceRanger99" required />
                </label>
              </div>
              ...
              {/* Role Selection - Size Matched */}
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-gray-300 text-xs font-bold uppercase tracking-wider">Alliance Role</span>
                </label>
                {/* We use the EXACT same 'input' class wrapper as above to guarantee identical size */}
                <div className="input input-bordered bg-slate-800/50 border-white/10 focus-within:border-purple-500 focus-within:ring-1 focus-within:ring-purple-500 flex items-center gap-2 text-white">
                  {/* Icon */}
                  ...
                  {/* Native Select styled to fill the container */}
                  <select className="grow bg-transparent border-none outline-none text-white :bg-slate-800 cursor-pointer h-full appearance-none">
                    <option disabled selected>Choose your path</option>
                    <option>Explorer (Buyer)</option>
                    <option>Merchant (Seller)</option>
                  </select>
                  {/* Custom Chevron Icon (since we hid the default one) */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 opacity-70 pointer-events-none">
