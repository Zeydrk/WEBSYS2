...
export default function Products() {
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-900 via-purple-900 to-slate-900">
      ...
      >
        {/* I think the overlay is the image part */}
        <div className="hero-overlay"></div>
        <div className="hero-content text-neutral-content text-center">
          <div className="max-w-md">
            <h1 className="mb-5 text-5xl font-bold">
              "Get Exclusive Pets All Around The World"
            </h1>
            <p className="mb-5">
      ...
      <div>
        ...
        <div className="flex flex-row p-6">
          ...
          <div className="ml-3">
            ...
            {/* div for heading of the filter  */}
            <div>
              <h1>5 Results found</h1>
            </div>
            {/* Filter Box */}
            <div className="card bg-base-100 flex flex-col mt-5 text-left">
              {/* Specie Filter */}
              <div className="card-body text-left">
                ...
                {/* Species Type */}
                <div className="mt-3">
                  <div className="collapse collapse-arrow bg-base-100 border-amber-50 border">
                    <input type="checkbox" />
                    ...
                    <div className="collapse-content text-sm">
                        <ul>
                            <li className="mt-2">Specie 1</li>
                            <li className="mt-4">Specie 2</li>
                            <li className="mt-4">Specie 3</li>
                        </ul>
                    </div>
                  </div>
                </div>
