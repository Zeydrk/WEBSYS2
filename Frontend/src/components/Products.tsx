        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/4 shrink-0 lg:sticky lg:top-8 h-fit">
            ...
            <div className="breadcrumbs text-sm mb-4 text-purple-200">
              <ul>
                <li><a className="hover:text-white transition-colors">Home</a></li>
            ...
            <div className="card bg-slate-800/40 backdrop-blur-md border border-white/10 shadow-xl overflow-hidden">
              <div className="card-body p-6">
                ...
                {/* Header */}
                <h3 className="card-title text-lg text-purple-300">Filter Options</h3>
                ...
                <div className="form-control w-full mt-2">
                  <label className="input input-bordered border-white/20 bg-slate-900/50 flex items-center gap-2 focus-within:border-purple-400 focus-within:ring-1 focus-within:ring-purple-400 text-sm">
                    ...
                    <input type="search" className="grow text-white placeholder-gray-400" placeholder="Search species..." required />
                  </label>
                </div>
                    ...
                    <div className="collapse-content text-sm text-gray-300">
                      <ul className="space-y-2 py-2">
                        <li className="flex items-center gap-2 hover:text-purple-300 cursor-pointer">
                            <input type="checkbox" className="checkbox checkbox-xs checkbox-primary" /> Specie 1
                        </li>
                        <li className="flex items-center gap-2 hover:text-purple-300 cursor-pointer">
                            <input type="checkbox" className="checkbox checkbox-xs checkbox-primary" /> Specie 2
                        </li>
                        <li className="flex items-center gap-2 hover:text-purple-300 cursor-pointer">
                            <input type="checkbox" className="checkbox checkbox-xs checkbox-primary" /> Specie 3
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              {pets.map((pet:Pet) => (
                ...
                <div key={pet.petId}   className="card w-full bg-base-100 shadow-xl image-full hover:scale-[1.02] transition-transform duration-300 hover:shadow-purple-500/20">
                  <figure>
                  ...
                  <div className="card-body">
                    ...
                    <h2 className="card-title text-2xl text-white">{pet.name}</h2>
              ...
              <div className="card w-full bg-base-100 shadow-xl image-full hover:scale-[1.02] transition-transform duration-300 hover:shadow-purple-500/20 cursor-pointer group">
                ...
                <div className="card-body">
                  <div className="badge badge-accent badge-outline mb-2">Planet Name</div>
              ...
              <div className="card w-full bg-base-100 shadow-xl image-full hover:scale-[1.02] transition-transform duration-300 hover:shadow-purple-500/20 cursor-pointer group">
                ...
                <div className="card-body">
                   <div className="badge badge-outline text-white mb-2">Planet Name</div>
